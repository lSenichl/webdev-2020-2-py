...
lnd_co1 = input('Введите имя устройства: ')
lnd_co2 = input('Введите имя параметра (' + ', '.join(london_co[lnd_co1]) + ') : ').lower()

print(london_co[lnd_co1].get(lnd_co2, 'Такого параметра нет'))